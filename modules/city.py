...
class City(QFrame):
    def __init__(self, name, time, temp, desc, max_temp, min_temp, panel):
        ...
        self.range_label = QLabel(f"Макс: {max_temp}, Мін: {min_temp}")
        ...
        self.right_layout.addWidget(self.temp_label, alignment=Qt.AlignmentFlag.AlignRight)
